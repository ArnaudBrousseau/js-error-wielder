(function() {
  if (window._errs && _errs.shift) {
    for (var p = "https:" == location.protocol, w = "<form method='post' action='http" + (p ? "s" : "") + "://errorception.com/projects/" + _errs.shift() + "/err'>", m = [], r = "before", s = document.getElementsByTagName("script")[0], g = Array.prototype.slice, t = navigator.userAgent, k, n = function(a, e) {
        ...
        try {
          if (a.x = {}, n(_errs.meta || {}, function(c, b) {
            ...
            for (var e, c = a.callee, b = /function\s*([\w\-$]+)?\s*\(/i, d = [], h; c && c.arguments && 10 > d.length;) h = b.test(c.toString()) ? RegExp.$1 || "{anonymous}" : "{anonymous}", d.push(h + "(" + (p ? "" : j(g.call(c.arguments || []))) + ")"), c = c.caller;
        ...
        for (var a, e = 0, c = {}, b = function(a, b) {
            ...
            return "Error loading script" == a && /Firefox/.test(t) || /originalCreateNotification/.test(a) || /jid1\-ejhbjdxm9zr4tq/.test(b) || "miscellaneous_bindings" == b
          }, j = function(c, d, e) {
            n({
              message: c,
              url: d,
